:- module(clpfd,[
	...
	all_equal_reif/2,all_different/1,all_different/2,all_distinct/1,
	all_distinct/2,all_different_except_0/1,all_distinct_except_0/1,nvalue/2,
	assignment/2,assignment/3,symmetric_all_different/1,symmetric_all_distinct/1,
	increasing/1,increasing/2,decreasing/1,decreasing/2,
	sorting/3,keysorting/2,keysorting/3,lex_chain/1,
	lex_chain/2,bool_and/2,bool_or/2,bool_xor/2,
	bool_channel/4,labeling/2,indomain/1,first_bound/2,
	later_bound/2,minimize/2,minimize/3,maximize/2,
	maximize/3,solve/2,element/3,element/2,
	relation/3,table/2,table/3,case/3,
	case/4,circuit/1,circuit/2,subcircuit/1,
	subcircuit/2,network_flow/2,network_flow/3,domain/2,
	domain/3,in/2,in_set/2,disjoint1/1,
	disjoint1/2,disjoint2/1,disjoint2/2,diffn/1,
	diffn/2,bin_packing/2,geost/2,geost/3,
	geost/4,cumulative/2,cumulatives/2,cumulatives/3,
	multi_cumulative/2,multi_cumulative/3,automaton/3,automaton/8,
	automaton/9,inflexion/3,inflexion_signature/2,regular/2,
	value_precede_chain/2,value_precede_chain/3,seq_precede_chain/1,seq_precede_chain/2,
