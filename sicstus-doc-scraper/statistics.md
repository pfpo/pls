...
The number of times the search has found an intermediate (for optimization problems)
or final (for satisfaction problems) solution.
...
The number of times the search has proven optimality (for optimization problems)
or found all solutions (for satisfaction problems).
