...
list, same\_length is determinate and terminating.
...
a given List. For this to be sure of termination,
 List must be a proper list.
The predicate proper\_suffix/2 has the same requirement.
If Length is instantiated or Suffix is a proper list, this predicate
is determinate.
...
list, rotate\_list is determinate.
...
in which case rotate\_list is determinate and terminating.
